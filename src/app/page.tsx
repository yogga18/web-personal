...
export default function Home() {
  return (
    <div className="mt-10">
      ...
      <div className="mt-8">
        <div className="w-4/5 md:w-5/6 m-auto shadow-lg rounded-md">
          <div className="w-full bg-[#0d26e4] p-4 border-2 border-blue-400 text-white rounded-b-md border-t-0 relative">
            <div className="pb-20">
              <p className="font-sans text-justify">
                ...
                pengalaman saya bekerja di bidang retail. Kemudian, saya
                melakukan <i>career switching</i> ke bidang pengembangan web
                sebagai Front End Developer dengan keterampilan :
              </p>
              <ol className="py-2">
